...
hydrate= tk.Checkbutton(master=checkList,text='Hydrate!!!')
code= tk.Checkbutton(master=checkList, text='code(NO ZERO DAYS!)')
stretch= tk.Checkbutton(master=checkList, text='Stretch')
